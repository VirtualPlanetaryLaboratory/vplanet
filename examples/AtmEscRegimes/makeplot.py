...
axes[0,1].legend(loc="upper left", framealpha=0, fontsize=11.5, ncol=1)

## Lower left: planetary mass ##
axes[1,0].plot(time, regimes.auto.Mass, color="C0")
axes[1,0].plot(time, regimes.el.Mass, color="C1")
axes[1,0].plot(time, regimes.rr.Mass, color="C2")
axes[1,0].plot(time, regimes.bondi.Mass, color="C3")
...
axes[1,1].plot(time, regimes.auto.PlanetRadius, color="C0")
axes[1,1].plot(time, regimes.el.PlanetRadius, color="C1")
axes[1,1].plot(time, regimes.rr.PlanetRadius, color="C2")
axes[1,1].plot(time, regimes.bondi.PlanetRadius, color="C3")

# Initial value
axes[1,1].axhline(regimes.auto.PlanetRadius[0], color="k", ls="--")

# Format
axes[1,1].set_xlabel("Time [yr]")
axes[1,1].set_ylim(0, 35)
axes[1,1].set_ylabel(r"Radius [R$_{\oplus}$]")
...
# Format
axes[0,1].set_ylim(-1e15, -1.0e9)
axes[0,1].set_yscale("symlog", linthreshy=0.1)
axes[0,1].set_ylabel(r"$\dot{M}_{envelope}$ [kg/s]")
axes[0,1].legend(loc="upper left", framealpha=0, fontsize=11.5, ncol=1)

## Lower left: planetary mass ##
axes[1,0].plot(time, bondi.auto.Mass, color="C0")
axes[1,0].plot(time, bondi.bondi.Mass, color="C3")
...
## Lower right: Planet Radius ##
axes[1,1].plot(time, bondi.auto.PlanetRadius, color="C0")
axes[1,1].plot(time, bondi.bondi.PlanetRadius, color="C3")

# Initial value
axes[1,1].axhline(bondi.auto.PlanetRadius[0], color="k", ls="--")
