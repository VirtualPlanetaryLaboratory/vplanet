...
plt.text(y2+0.03,0.01,r'2',color='0.5',fontweight='bold',fontsize=20)
plt.text(y4+0.01,0.02,r'4',color='0.5',fontweight='bold',fontsize=20)
plt.text(y1-0.05,0.03,r'1',color='0.5',fontweight='bold',fontsize=20)
