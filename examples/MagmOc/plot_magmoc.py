...
Initial_water = 1
# read data
data = np.loadtxt("GJ_eps03_200TO_petit.forward")
...
ax1.set_xscale('log')
ax1.set_xlim([1e-3,time[n_time-1]*1e-6])
...
ax9.plot(time*10**-6, 100*(N_H_tot/N_H_tot[0]-1),                          color=cmap(0), label='H')
ax9.plot(time*10**-6, 100*(N_O_tot/N_O_tot[0]-1),                          color=cmap(0), label='O',   linestyle='--')
# ax9.plot(time*10**-6, 100*((N_O_tot/N_O_tot[0]-1)-(N_H_tot/N_H_tot[0]-1)), color=cmap(0), label='O-H', linestyle=':')
