...
plt.plot(SS.Earth.Time, SS.Earth.HelioInc, "k")
...
plt.plot(SS.Earth.Time, SS.Earth.HelioLongP, "k", marker=".", linewidth=0)
plt.xlabel("Time (yrs)")
plt.ylim(0, 360)
...
plt.plot(SS.Earth.Time, SS.Earth.HelioLongA, color="k", marker=".", linewidth=0)
plt.ylim(0, 360)
