...
def fig2x3(out,nfig,color='k',legendon=False):
    ...
    panel += 1
    plt.subplot(rows,cols,panel)
    plt.plot(out.tidalearth.Time,out.tidalearth.SemiMajorAxis,color=color,label='a(0)=%.2f'%out.tidalearth.SemiMajorAxis[0])
...
plt.semilogy(planet.TUMan,planet.PowerEqtide,color=colors[0],label='a(0)=%.2f'%planet.SemiMajorAxis[0])
planet=out1.tidalearth
plt.semilogy(planet.TUMan,planet.PowerEqtide,color=colors[1],label='a(0)=%.2f'%planet.SemiMajorAxis[0])
planet=out2.tidalearth
plt.semilogy(planet.TUMan,planet.PowerEqtide,color=colors[2],label='a(0)=%.2f'%planet.SemiMajorAxis[0])
