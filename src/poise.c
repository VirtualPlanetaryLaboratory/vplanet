...
void InitializeOutputPoise(OUTPUT *output, fnWriteOutput fnWrite[]) {
  ...
  */
  ...
  output[OUT_TEMPLANDLAT].iModuleBit = POISE;
  ...
  output[OUT_TEMPWATERLAT].iModuleBit = POISE;
  ...
  output[OUT_ALBEDOLANDLAT].iModuleBit = POISE;
  ...
  output[OUT_ALBEDOWATERLAT].iModuleBit = POISE;
