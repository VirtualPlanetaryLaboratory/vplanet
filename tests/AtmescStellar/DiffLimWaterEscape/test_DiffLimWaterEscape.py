...
@benchmark( 
   { 
       ...
       "log.final.system.TotAngMom": {"value": 1.140631e+42, "unit": (u.kg * u.m ** 2) / u.sec, "rtol": 1e-4}, 
       "log.final.system.TotEnergy": {"value": -1.889906e+39, "unit": u.Joule, "rtol": 1e-4}, 
       "log.final.system.PotEnergy": {"value": -1.631379e+40, "unit": u.Joule, "rtol": 1e-4}, 
       "log.final.system.KinEnergy": {"value": 9.851559e+35, "unit": u.Joule, "rtol": 1e-4}, 
       ...
       "log.final.star.RotAngMom": {"value": 2.171147e+40, "unit": (u.kg * u.m ** 2) / u.sec, "rtol": 1e-4}, 
       "log.final.star.RotVel": {"value": 7134.215982, "unit": u.m / u.sec, "rtol": 1e-4}, 
       "log.final.star.BodyType": {"value": 0.000000, "rtol": 1e-4}, 
       "log.final.star.RotRate": {"value": 9.074983e-05, "unit": 1 / u.sec, "rtol": 1e-4}, 
       "log.final.star.RotPer": {"value": 6.923633e+04, "unit": u.sec, "rtol": 1e-4}, 
       "log.final.star.Density": {"value": 8.793460e+04, "unit": u.kg / u.m ** 3, "rtol": 1e-4}, 
       "log.final.star.HZLimitDryRunaway": {"value": 3.236262e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.star.HZLimRecVenus": {"value": 2.926997e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.star.HZLimRunaway": {"value": 3.845736e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.star.HZLimMoistGreenhouse": {"value": 3.872908e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.star.HZLimMaxGreenhouse": {"value": 7.519105e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.star.HZLimEarlyMars": {"value": 8.200584e+09, "unit": u.m, "rtol": 1e-4}, 
       ...
       "log.final.star.LXUVTot": {"value": 5.680624e-07, "unit": u.LSUN, "rtol": 1e-4}, 
       "log.final.star.LostEnergy": {"value": 1.442293e+40, "unit": u.Joule, "rtol": 1e-4}, 
       "log.final.star.LostAngMom": {"value": 1.116792e+42, "unit": (u.kg * u.m ** 2) / u.sec, "rtol": 1e-4}, 
       "log.final.star.Luminosity": {"value": 0.000568, "unit": u.LSUN, "rtol": 1e-4}, 
       "log.final.star.LXUVStellar": {"value": 2.184768e+20, "unit": u.W, "rtol": 1e-4}, 
       "log.final.star.Temperature": {"value": 2649.349410, "unit": u.K, "rtol": 1e-4}, 
       "log.final.star.LXUVFrac": {"value": 0.001000, "rtol": 1e-4}, 
       "log.final.star.RossbyNumber": {"value": 0.009905, "rtol": 1e-4}, 
       "log.final.star.DRotPerDtStellar": {"value": 1.447247e-12, "rtol": 1e-4}, 
       ...
       "log.final.b.HZLimitDryRunaway": {"value": 3.236288e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.b.HZLimRecVenus": {"value": 2.926997e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.b.HZLimRunaway": {"value": 3.845736e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.b.HZLimMoistGreenhouse": {"value": 3.872908e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.b.HZLimMaxGreenhouse": {"value": 7.519105e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.b.HZLimEarlyMars": {"value": 8.200584e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.b.Instellation": {"value": 5825.749042, "unit": u.kg / u.sec ** 3, "rtol": 1e-4}, 
       ...
       "log.final.b.SurfWaterMass": {"value": 0.189789, "unit": u.TO, "rtol": 1e-4}, 
       "log.final.b.EnvelopeMass": {"value": 0.000000, "unit": u.kg, "rtol": 1e-4}, 
       "log.final.b.OxygenMass": {"value": 1553.649098, "unit": u.bar, "rtol": 1e-4}, 
       "log.final.b.RGLimit": {"value": 3.704012e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.b.XO": {"value": 0.952470, "rtol": 1e-4}, 
       ...
       "log.final.b.FXUV": {"value": 5.825749, "unit": u.W / u.m ** 2, "rtol": 1e-4}, 
       "log.final.b.AtmXAbsEffH2O": {"value": 0.041374, "rtol": 1e-4}, 
       "log.final.b.RocheRadius": {"value": 4.290313e+07, "unit": u.m, "rtol": 1e-4}, 
       "log.final.b.BondiRadius": {"value": 9.942291e+08, "unit": u.m, "rtol": 1e-4}, 
       "log.final.b.HEscapeRegime": {"value": 8.000000, "rtol": 1e-4}, 
       "log.final.b.RRCriticalFlux": {"value": 41.454587, "unit": u.W / u.m ** 2, "rtol": 1e-4}, 
       "log.final.b.CrossoverMass": {"value": 3.012983e-26, "unit": u.kg, "rtol": 1e-4}, 
       "log.final.b.WaterEscapeRegime": {"value": 4.000000, "rtol": 1e-4}, 
       "log.final.b.FXUVCRITDRAG": {"value": 0.124896, "unit": u.W / u.m ** 2, "rtol": 1e-4}, 
       "log.final.b.HREFFLUX": {"value": 4.676163e+17, "unit": 1 / u.m ** 2 / u.sec, "rtol": 1e-4}, 
       "log.final.b.XO2": {"value": 0.951313, "rtol": 1e-4}, 
       "log.final.b.XH2O": {"value": 0.048687, "rtol": 1e-4}, 
       "log.final.b.HDiffFlux": {"value": 9.952610e+15, "unit": 1 / u.m ** 2 / u.sec, "rtol": 1e-4}, 
       "log.final.b.HRefODragMod": {"value": 0.024327, "rtol": 1e-4}, 
       ...
       "log.final.e.HZLimitDryRunaway": {"value": 3.236328e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.e.HZLimRecVenus": {"value": 2.926997e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.e.HZLimRunaway": {"value": 3.845736e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.e.HZLimMoistGreenhouse": {"value": 3.872908e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.e.HZLimMaxGreenhouse": {"value": 7.519105e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.e.HZLimEarlyMars": {"value": 8.200584e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.e.Instellation": {"value": 905.969757, "unit": u.kg / u.sec ** 3, "rtol": 1e-4}, 
       ...
       "log.final.e.SurfWaterMass": {"value": 7.540808, "unit": u.TO, "rtol": 1e-4}, 
       "log.final.e.EnvelopeMass": {"value": 0.000000, "unit": u.kg, "rtol": 1e-4}, 
       "log.final.e.OxygenMass": {"value": 401.246697, "unit": u.bar, "rtol": 1e-4}, 
       "log.final.e.RGLimit": {"value": 3.765019e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.e.XO": {"value": 0.381627, "rtol": 1e-4}, 
       ...
       "log.final.e.FXUVCRITDRAG": {"value": 0.413163, "unit": u.W / u.m ** 2, "rtol": 1e-4}, 
       "log.final.e.HREFFLUX": {"value": 2.112524e+17, "unit": 1 / u.m ** 2 / u.sec, "rtol": 1e-4}, 
       "log.final.e.XO2": {"value": 0.104862, "rtol": 1e-4}, 
       "log.final.e.XH2O": {"value": 0.895138, "rtol": 1e-4}, 
       "log.final.e.HDiffFlux": {"value": 9.564462e+16, "unit": 1 / u.m ** 2 / u.sec, "rtol": 1e-4}, 
       "log.final.e.HRefODragMod": {"value": 0.006290, "rtol": 1e-4}, 
       "log.final.e.KTide": {"value": 0.898227, "rtol": 1e-4}, 
       "log.final.e.RGDuration": {"value": 3.80341e+08, "unit": u.yr, "rtol": 1e-4}, 
   } 
)
