...
@benchmark(
    {
        ...
        "log.initial.system.TotEnergy": {"value": -9.104487e40, "unit": u.Joule},
        ...
        "log.initial.planet.Radius": {"value": 1.885546e08, "unit": u.m},
        ...
        "log.initial.planet.HZLimitDryRunaway": {"value": 1.887931e11, "unit": u.m},
        "log.initial.planet.HZLimRecVenus": {"value": 1.640992e11, "unit": u.m},
        "log.initial.planet.HZLimRunaway": {"value": 2.178515e11, "unit": u.m},
        "log.initial.planet.HZLimMoistGreenhouse": {"value": 2.171294e11, "unit": u.m},
        "log.initial.planet.HZLimMaxGreenhouse": {"value": 3.929566e11, "unit": u.m},
        "log.initial.planet.HZLimEarlyMars": {"value": 4.286401e11, "unit": u.m},
        "log.initial.planet.Instellation": {
            "value": 2.643806e05,
            "unit": u.kg / u.sec**3,
        },
        "log.initial.planet.MeanMotion": {"value": 6.296062e-06, "unit": 1 / u.sec},
        "log.initial.planet.OrbPeriod": {"value": 9.979547e05, "unit": u.sec},
        "log.initial.planet.SemiMajorAxis": {"value": 1.495979e10, "unit": u.m},
        ...
        "log.initial.planet.RGLimit": {"value": 2.083395e11, "unit": u.m},
        ...
        "log.initial.planet.RadSolid": {"value": 7.606867e06, "unit": u.m},
        ...
        "log.initial.planet.DEnvMassDt": {"value": -6.984298e11, "unit": u.kg / u.sec},
        ...
        "log.initial.planet.BondiRadius": {"value": 6.418556e07, "unit": u.m},
        "log.initial.planet.HEscapeRegime": {"value": 3.000000},
        "log.initial.planet.RRCriticalFlux": {
            "value": 0.018709,
            "unit": u.W / u.m**2,
        },
        ...
        "log.final.star.Radius": {"value": 1.334689e09, "unit": u.m, "rtol": 1e-4},
        ...
        "log.final.star.RotPer": {"value": 6.880220e04, "unit": u.sec, "rtol": 1e-4},
        ...
        "log.final.star.LXUVStellar": {"value": 4.556190e23, "unit": u.W, "rtol": 1e-4},
        ...
        "log.final.planet.Radius": {"value": 1.876819e08, "unit": u.m, "rtol": 1e-4},
        "log.final.planet.RadGyra": {"value": 0.500000, "rtol": 1e-4},
        "log.final.planet.BodyType": {"value": 0.000000, "rtol": 1e-4},
        "log.final.planet.Density": {
            "value": 0.425367,
            "unit": u.kg / u.m**3,
            "rtol": 1e-4,
        },
        "log.final.planet.HZLimitDryRunaway": {
            "value": 1.477889e11,
            "unit": u.m,
            "rtol": 1e-4,
        },
        "log.final.planet.HZLimRecVenus": {
            "value": 1.285735e11,
            "unit": u.m,
            "rtol": 1e-4,
        },
        "log.final.planet.HZLimRunaway": {
            "value": 1.706938e11,
            "unit": u.m,
            "rtol": 1e-4,
        },
        "log.final.planet.HZLimMoistGreenhouse": {
            "value": 1.701232e11,
            "unit": u.m,
            "rtol": 1e-4,
        },
        "log.final.planet.HZLimMaxGreenhouse": {
            "value": 3.082748e11,
            "unit": u.m,
            "rtol": 1e-4,
        },
        "log.final.planet.HZLimEarlyMars": {
            "value": 3.362667e11,
            "unit": u.m,
            "rtol": 1e-4,
        },
        "log.final.planet.Instellation": {
            "value": 1.620097e05,
            "unit": u.kg / u.sec**3,
            "rtol": 1e-4,
        },
        "log.final.planet.MeanMotion": {
            "value": 6.296062e-06,
            "unit": 1 / u.sec,
            "rtol": 1e-4,
        },
        "log.final.planet.OrbPeriod": {
            "value": 9.979548e05,
            "unit": u.sec,
            "rtol": 1e-4,
        },
        "log.final.planet.SemiMajorAxis": {
            "value": 1.495979e10,
            "unit": u.m,
            "rtol": 1e-4,
        },
        "log.final.planet.LXUVTot": {
            "value": -1.000000,
            "unit": u.kg / u.sec**3,
            "rtol": 1e-4,
        },
        "log.final.planet.SurfWaterMass": {
            "value": 0.000000,
            "unit": u.kg,
            "rtol": 1e-4,
        },
        ...
        "log.final.planet.RGLimit": {"value": 1.632814e11, "unit": u.m, "rtol": 1e-4},
        "log.final.planet.XO": {"value": 0.000000, "rtol": 1e-4},
        "log.final.planet.EtaO": {"value": 0.000000, "rtol": 1e-4},
        "log.final.planet.PlanetRadius": {
            "value": 29.425997,
            "unit": u.Rearth,
            "rtol": 1e-4,
        },
        "log.final.planet.OxygenMantleMass": {
            "value": 0.000000,
            "unit": u.kg,
            "rtol": 1e-4,
        },
        "log.final.planet.RadXUV": {"value": 29.425997, "unit": u.Rearth, "rtol": 1e-4},
        "log.final.planet.RadSolid": {"value": 7.606867e06, "unit": u.m, "rtol": 1e-4},
        "log.final.planet.PresXUV": {"value": 5.000000, "rtol": 1e-4},
        "log.final.planet.ScaleHeight": {
            "value": 401.211434,
            "unit": u.km,
            "rtol": 1e-4,
        },
        ...
        "log.final.planet.DEnvMassDt": {
            "value": -4.568136e09,
            "unit": u.kg / u.sec,
            "rtol": 1e-4,
        },
        "log.final.planet.FXUV": {
            "value": 162.009738,
            "unit": u.W / u.m**2,
            "rtol": 1e-4,
        },
        ...
        "log.final.planet.BondiRadius": {
            "value": 7.153500e07,
            "unit": u.m,
            "rtol": 1e-4,
        },
        "log.final.planet.HEscapeRegime": {"value": 6.000000, "rtol": 1e-4},
        "log.final.planet.RRCriticalFlux": {
            "value": 0.018450,
            "unit": u.W / u.m**2,
            "rtol": 1e-4,
        },
