...
@benchmark( 
   { 
       ...
       "log.initial.b.HREFFLUX": {"value": 1.178796e+19, "unit": 1 / (u.m ** 2 * u.sec ** 1)}, 
       "log.initial.b.XO2": {"value": 0.000000}, 
       "log.initial.b.XH2O": {"value": 1.000000}, 
       "log.initial.b.HDiffFlux": {"value": 1.395966e+17, "unit": 1 / (u.m ** 2 * u.sec ** 1)}, 
       ...
       "log.initial.e.HREFFLUX": {"value": 3.326851e+18, "unit": 1 / (u.m ** 2 * u.sec ** 1)}, 
       "log.initial.e.XO2": {"value": 0.000000}, 
       "log.initial.e.XH2O": {"value": 1.000000}, 
       "log.initial.e.HDiffFlux": {"value": 1.031142e+17, "unit": 1 / (u.m ** 2 * u.sec ** 1)}, 
       ...
       "log.final.system.TotAngMom": {"value": 1.140769e+42, "unit": (u.kg * u.m ** 2) / u.sec, "rtol": 1e-4}, 
       "log.final.system.TotEnergy": {"value": -1.867690e+39, "unit": u.Joule, "rtol": 1e-4}, 
       "log.final.system.PotEnergy": {"value": -1.631379e+40, "unit": u.Joule, "rtol": 1e-4}, 
       "log.final.system.KinEnergy": {"value": 9.939890e+35, "unit": u.Joule, "rtol": 1e-4}, 
       "log.final.system.DeltaTime": {"value": 3.563133e+08, "unit": u.sec, "rtol": 1e-4}, 
       ...
       "log.final.star.RotAngMom": {"value": 2.180858e+40, "unit": (u.kg * u.m ** 2) / u.sec, "rtol": 1e-4}, 
       "log.final.star.RotVel": {"value": 7166.128057, "unit": u.m / u.sec, "rtol": 1e-4}, 
       "log.final.star.BodyType": {"value": 0.000000, "rtol": 1e-4}, 
       "log.final.star.RotRate": {"value": 9.115576e-05, "unit": 1 / u.sec, "rtol": 1e-4}, 
       "log.final.star.RotPer": {"value": 6.892801e+04, "unit": u.sec, "rtol": 1e-4}, 
       "log.final.star.Density": {"value": 8.793460e+04, "unit": u.kg / u.m ** 3, "rtol": 1e-4}, 
       "log.final.star.HZLimitDryRunaway": {"value": 3.236260e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.star.HZLimRecVenus": {"value": 2.926994e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.star.HZLimRunaway": {"value": 3.845733e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.star.HZLimMoistGreenhouse": {"value": 3.872905e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.star.HZLimMaxGreenhouse": {"value": 7.519099e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.star.HZLimEarlyMars": {"value": 8.200577e+09, "unit": u.m, "rtol": 1e-4}, 
       ...
       "log.final.star.LXUVTot": {"value": 5.680615e-07, "unit": u.LSUN, "rtol": 1e-4}, 
       "log.final.star.LostEnergy": {"value": 1.444514e+40, "unit": u.Joule, "rtol": 1e-4}, 
       "log.final.star.LostAngMom": {"value": 1.116832e+42, "unit": (u.kg * u.m ** 2) / u.sec, "rtol": 1e-4}, 
       "log.final.star.Luminosity": {"value": 0.000568, "unit": u.LSUN, "rtol": 1e-4}, 
       "log.final.star.LXUVStellar": {"value": 2.184764e+20, "unit": u.W, "rtol": 1e-4}, 
       "log.final.star.Temperature": {"value": 2649.348516, "unit": u.K, "rtol": 1e-4}, 
       "log.final.star.LXUVFrac": {"value": 0.001000, "rtol": 1e-4}, 
       "log.final.star.RossbyNumber": {"value": 0.009861, "rtol": 1e-4}, 
       "log.final.star.DRotPerDtStellar": {"value": 1.440802e-12, "rtol": 1e-4}, 
       ...
       "log.final.b.HZLimitDryRunaway": {"value": 3.236286e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.b.HZLimRecVenus": {"value": 2.926994e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.b.HZLimRunaway": {"value": 3.845733e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.b.HZLimMoistGreenhouse": {"value": 3.872905e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.b.HZLimMaxGreenhouse": {"value": 7.519099e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.b.HZLimEarlyMars": {"value": 8.200577e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.b.Instellation": {"value": 5825.739570, "unit": u.kg / u.sec ** 3, "rtol": 1e-4}, 
       ...
       "log.final.b.OxygenMass": {"value": 1146.046500, "unit": u.bar, "rtol": 1e-4}, 
       "log.final.b.RGLimit": {"value": 3.704009e+09, "unit": u.m, "rtol": 1e-4}, 
       ...
       "log.final.b.FXUV": {"value": 5.825740, "unit": u.W / u.m ** 2, "rtol": 1e-4}, 
       "log.final.b.AtmXAbsEffH2O": {"value": 0.041374, "rtol": 1e-4}, 
       "log.final.b.RocheRadius": {"value": 4.290313e+07, "unit": u.m, "rtol": 1e-4}, 
       "log.final.b.BondiRadius": {"value": 9.942294e+08, "unit": u.m, "rtol": 1e-4}, 
       ...
       "log.final.b.HREFFLUX": {"value": 4.676158e+17, "unit": 1 / (u.m ** 2 * u.sec ** 1), "rtol": 1e-4}, 
       "log.final.b.XO2": {"value": 1.000000, "rtol": 1e-4}, 
       "log.final.b.XH2O": {"value": 0.000000, "rtol": 1e-4}, 
       "log.final.b.HDiffFlux": {"value": 0.000000, "unit": 1 / (u.m ** 2 * u.sec ** 1), "rtol": 1e-4}, 
       ...
       "log.final.e.HZLimitDryRunaway": {"value": 3.236325e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.e.HZLimRecVenus": {"value": 2.926994e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.e.HZLimRunaway": {"value": 3.845733e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.e.HZLimMoistGreenhouse": {"value": 3.872905e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.e.HZLimMaxGreenhouse": {"value": 7.519099e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.e.HZLimEarlyMars": {"value": 8.200577e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.e.Instellation": {"value": 905.968284, "unit": u.kg / u.sec ** 3, "rtol": 1e-4}, 
       ...
       "log.final.e.SurfWaterMass": {"value": 3.053381, "unit": u.TO, "rtol": 1e-4}, 
       "log.final.e.EnvelopeMass": {"value": 0.000000, "unit": u.kg, "rtol": 1e-4}, 
       "log.final.e.OxygenMass": {"value": 1031.237269, "unit": u.bar, "rtol": 1e-4}, 
       "log.final.e.RGLimit": {"value": 3.765016e+09, "unit": u.m, "rtol": 1e-4}, 
       "log.final.e.XO": {"value": 0.554279, "rtol": 1e-4}, 
       ...
       "log.final.e.FXUV": {"value": 0.905968, "unit": u.W / u.m ** 2, "rtol": 1e-4}, 
       "log.final.e.AtmXAbsEffH2O": {"value": 0.073282, "rtol": 1e-4}, 
       "log.final.e.RocheRadius": {"value": 8.653872e+07, "unit": u.m, "rtol": 1e-4}, 
       "log.final.e.BondiRadius": {"value": 3.142137e+08, "unit": u.m, "rtol": 1e-4}, 
       ...
       "log.final.e.FXUVCRITDRAG": {"value": 0.297806, "unit": u.W / u.m ** 2, "rtol": 1e-4}, 
       "log.final.e.HREFFLUX": {"value": 2.112521e+17, "unit": 1 / (u.m ** 2 * u.sec ** 1), "rtol": 1e-4}, 
       "log.final.e.XO2": {"value": 0.426459, "rtol": 1e-4}, 
       "log.final.e.XH2O": {"value": 0.573541, "rtol": 1e-4}, 
       "log.final.e.HDiffFlux": {"value": 6.894030e+16, "unit": 1 / (u.m ** 2 * u.sec ** 1), "rtol": 1e-4}, 
       "log.final.e.HRefODragMod": {"value": 0.003131, "rtol": 1e-4}, 
       "log.final.e.KTide": {"value": 0.898227, "rtol": 1e-4}, 
       "log.final.e.RGDuration": {"value": 3.80353e+08, "unit": u.yr, "rtol": 1e-4}, 
   } 
)
class TestLS16_AtmEsc_WaterLossModel(Benchmark): 
   pass 
