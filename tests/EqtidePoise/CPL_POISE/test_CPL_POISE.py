...
@benchmark( 
   { 
       ...
       "log.initial.gl514b.DZoblDtEqtide": {"value": -1.3757926086469330e-17, "unit": 1 / u.sec}, 
       ...
       "log.initial.gl514b.DOblDtEqtide": {"value": 3.4502716517739296e-17, "unit": u.rad / u.sec}, 
       ...
       "log.initial.gl514b.EqTidePower": {"value": 0.0000000000000000, "unit": 1 / u.sec}, 
       ...
       "log.final.gl514.SurfEnFluxTotal": {"value": 5.6927005606372457e-10, "unit": u.kg / u.sec ** 3, "rtol": 1e-4}, 
       ...
       "log.final.gl514.DRotPerDtEqtide": {"value": 2.3670446957670787e-20, "rtol": 1e-4}, 
       "log.final.gl514.DRotRateDtEqtide": {"value": -2.1346978387082093e-32, "unit": 1 / u.sec ** 2, "rtol": 1e-4}, 
       "log.final.gl514.EqRotRateDiscrete": {"value": 7.7800437205928784e-07, "unit": 1 / u.sec, "rtol": 1e-4}, 
       "log.final.gl514.EqRotPerDiscrete": {"value": 8.0760282754564984e+06, "unit": u.sec, "rtol": 1e-4}, 
       "log.final.gl514.EqRotRateCont": {"value": 1.5164601885389768e-06, "unit": 1 / u.sec, "rtol": 1e-4}, 
       "log.final.gl514.EqRotPerCont": {"value": 4.1433236128889597e+06, "unit": u.sec, "rtol": 1e-4}, 
       "log.final.gl514.EqRotPer": {"value": 4.1433236128889597e+06, "unit": u.sec, "rtol": 1e-4}, 
       ...
       "log.final.gl514.RotTimeEqtide": {"value": 1.1151120264596737e+26, "unit": u.sec, "rtol": 1e-4}, 
       "log.final.gl514.EnvK2": {"value": 0.0100000000000000, "rtol": 1e-4}, 
       "log.final.gl514.OblTimeEqtide": {"value": -1.0000000000000000, "rtol": 1e-4}, 
       "log.final.gl514.PowerEqtide": {"value": 1.2346074026431721e+10, "unit": u.W, "rtol": 1e-4}, 
       "log.final.gl514.SurfEnFluxEqtide": {"value": 5.6927005606372457e-10, "unit": u.kg / u.sec ** 3, "rtol": 1e-4}, 
       ...
       "log.final.gl514b.SurfEnFluxTotal": {"value": 1.4096430839727183, "unit": u.kg / u.sec ** 3, "rtol": 1e-4}, 
       ...
       "log.final.gl514b.MeanMotion": {"value": 5.1866958137285860e-07, "unit": 1 / u.sec, "rtol": 1e-4}, 
       ...
       "log.final.gl514b.DsemiDtEqtide": {"value": 1.2351242905112555e-10, "unit": u.m / u.sec, "rtol": 1e-4}, 
       "log.final.gl514b.DeccDtEqtide": {"value": 5.8376560316535848e-22, "unit": 1 / u.sec, "rtol": 1e-4}, 
       "log.final.gl514b.DMeanMotionDtEqtide": {"value": -1.5221408360256705e-27, "unit": 1 / u.sec ** 2, "rtol": 1e-4}, 
       "log.final.gl514b.DOrbPerDtEqtide": {"value": 3.5551108660833393e-14, "rtol": 1e-4}, 
       "log.final.gl514b.EccTimeEqtide": {"value": 7.7085733993229242e+20, "unit": u.sec, "rtol": 1e-4}, 
       "log.final.gl514b.SemiTimeEqtide": {"value": 5.1112509016620787e+20, "unit": u.sec, "rtol": 1e-4}, 
       "log.final.gl514b.DHEccDtEqtide": {"value": 0.0000000000000000, "unit": 1 / u.sec, "rtol": 1e-4}, 
       "log.final.gl514b.DKEccDtEqtide": {"value": 5.8376560316535848e-22, "unit": 1 / u.sec, "rtol": 1e-4}, 
       "log.final.gl514b.DXoblDtEqtide": {"value": 3.1641064275885797e-17, "unit": 1 / u.sec, "rtol": 1e-4}, 
       "log.final.gl514b.DYoblDtEqtide": {"value": 0.0000000000000000, "unit": 1 / u.sec, "rtol": 1e-4}, 
       "log.final.gl514b.DZoblDtEqtide": {"value": -1.3757926344613379e-17, "unit": 1 / u.sec, "rtol": 1e-4}, 
       ...
       "log.final.gl514b.DOblDtEqtide": {"value": 3.4502717078725021e-17, "unit": u.rad / u.sec, "rtol": 1e-4}, 
       "log.final.gl514b.DRotPerDtEqtide": {"value": 3.7660242031908285e-11, "rtol": 1e-4}, 
       "log.final.gl514b.DRotRateDtEqtide": {"value": -3.1698264008103670e-20, "unit": 1 / u.sec ** 2, "rtol": 1e-4}, 
       "log.final.gl514b.EqRotRateDiscrete": {"value": 7.7800437205928784e-07, "unit": 1 / u.sec, "rtol": 1e-4}, 
       "log.final.gl514b.EqRotPerDiscrete": {"value": 8.0760282754564984e+06, "unit": u.sec, "rtol": 1e-4}, 
       "log.final.gl514b.EqRotRateCont": {"value": 1.5164601885389768e-06, "unit": 1 / u.sec, "rtol": 1e-4}, 
       "log.final.gl514b.EqRotPerCont": {"value": 4.1433236128889597e+06, "unit": u.sec, "rtol": 1e-4}, 
       "log.final.gl514b.EqRotPer": {"value": 4.1433236128889597e+06, "unit": u.sec, "rtol": 1e-4}, 
       "log.final.gl514b.EqTidePower": {"value": 0.0000000000000000, "unit": 1 / u.sec, "rtol": 1e-4}, 
       ...
       "log.final.gl514b.RotTimeEqtide": {"value": 2.2941966521421440e+15, "unit": u.sec, "rtol": 1e-4}, 
       ...
       "log.final.gl514b.PowerEqtide": {"value": 3.1779002901179475e+15, "unit": u.W, "rtol": 1e-4}, 
       "log.final.gl514b.SurfEnFluxEqtide": {"value": 1.4096430839727183, "unit": u.kg / u.sec ** 3, "rtol": 1e-4}, 
       "log.final.gl514b.TGlobal": {"value": 676.2684488390486877, "unit": u.sec, "rtol": 1e-4}, 
       ...
       "log.final.gl514b.FluxOutGlobal": {"value": 1046.1310580736117117, "unit": u.kg / u.sec ** 3, "rtol": 1e-4}, 
       ...
       "log.final.gl514b.TempLat": {"value": 557.2252934226637535, "unit": u.sec, "rtol": 1e-4}, 
       ...
       "log.final.gl514b.FluxMerid": {"value": -2.0352457779998288e+16, "unit": u.Joule, "rtol": 1e-4}, 
       "log.final.gl514b.FluxIn": {"value": 486.1623348490649050, "unit": u.kg / u.sec ** 3, "rtol": 1e-4}, 
       "log.final.gl514b.FluxOut": {"value": 797.3308632533672835, "unit": u.kg / u.sec ** 3, "rtol": 1e-4}, 
       "log.final.gl514b.DivFlux": {"value": -311.1690732121607539, "unit": u.kg / u.sec ** 3, "rtol": 1e-4}, 
       ...
       "log.final.gl514b.EnergyResL": {"value": 7.6965989137534052e-11, "unit": u.kg / u.sec ** 3, "rtol": 1e-4}, 
       "log.final.gl514b.EnergyResW": {"value": 8.5833562479820102e-11, "unit": u.kg / u.sec ** 3, "rtol": 1e-4}, 
       "log.final.gl514b.BedrockH": {"value": 0.0000000000000000, "unit": u.m, "rtol": 1e-4}, 
       "log.final.gl514b.TempLandLat": {"value": 545.8665750487864443, "unit": u.sec, "rtol": 1e-4}, 
       "log.final.gl514b.TempWaterLat": {"value": 563.0767544031458556, "unit": u.sec, "rtol": 1e-4}, 
       ...
       "log.final.gl514b.TempMinLat": {"value": 520.6587997956706886, "unit": u.sec, "rtol": 1e-4}, 
       "log.final.gl514b.TempMaxLat": {"value": 598.1732888468366127, "unit": u.sec, "rtol": 1e-4}, 
       ...
       "log.final.gl514b.TempMaxLand": {"value": 657.9980332140348764, "unit": u.sec, "rtol": 1e-4}, 
       "log.final.gl514b.TempMaxWater": {"value": 568.6092758126221725, "unit": u.sec, "rtol": 1e-4}, 
       "log.final.gl514b.PeakInsol": {"value": 4243.8792251330123690, "unit": u.kg / u.sec ** 3, "rtol": 1e-4}, 
