<<<<<<< HEAD:tests/BinaryTides/test_BinaryTides.py
...
@benchmark( 
   { 
       ...
       "log.final.system.DeltaTime": {"value": 1.180297e+09, "unit": u.sec, "rtol": 1e-4}, 
...
class Test_BinaryTides(Benchmark):
    pass
>>>>>>> 4c18ee466e6db05e4c7989dcb7a270145d630d3a:tests/EqtideStellar/BinaryTides/test_BinaryTides.py
