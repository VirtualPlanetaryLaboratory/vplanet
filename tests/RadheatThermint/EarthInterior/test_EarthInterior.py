<<<<<<< HEAD:tests/EarthInterior/test_EarthInterior.py
...
@benchmark( 
   { 
       ...
       "log.final.system.DeltaTime": {"value": 6.298922e+11, "unit": u.sec, "rtol": 1e-4}, 
...
class Test_EarthInterior(Benchmark):
    pass
>>>>>>> 4c18ee466e6db05e4c7989dcb7a270145d630d3a:tests/RadheatThermint/EarthInterior/test_EarthInterior.py
