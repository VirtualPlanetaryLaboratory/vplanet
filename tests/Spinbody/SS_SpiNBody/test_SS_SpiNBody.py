...
@benchmark(
    {
        ...
        "log.initial.Mercury.PositionXSpiNBody": {"value": -1.9460729480525383e10},
        ...
        "log.initial.Mercury.VelYSpiNBody": {"value": -1.1164070038032818e04},
        ...
        "log.initial.Earth.PositionXSpiNBody": {"value": -2.6549739061807007e10},
        ...
        "log.initial.Mars.PositionYSpiNBody": {"value": -1.9601556499888902e09},
        "log.initial.Mars.PositionZSpiNBody": {"value": -5.1582818987714539e09},
        "log.initial.Mars.VelXSpiNBody": {"value": 1160.3534380638780021},
        "log.initial.Mars.VelYSpiNBody": {"value": 2.6297809759394790e04},
        ...
        "log.final.Star.TotOrbEnergy": {
            "value": -6.1982903940958659e33,
            "unit": u.Joule,
        },
        "log.final.Star.OrbPotEnergy": {"value": -1.0000000000000000, "unit": u.Joule},
        "log.final.Star.PositionXSpiNBody": {"value": -7.2996044877326745e05},
        "log.final.Star.PositionYSpiNBody": {"value": 1.4037087233830852e05},
        "log.final.Star.PositionZSpiNBody": {"value": 1.7226497595690369e04},
        ...
        "log.final.Mercury.MeanMotion": {
            "value": 8.2668331941002145e-07,
            "unit": 1 / u.sec,
        },
        "log.final.Mercury.OrbPeriod": {"value": 7.6004742803613152e06, "unit": u.sec},
        "log.final.Mercury.SemiMajorAxis": {
            "value": 5.7908781130334373e10,
            "unit": u.m,
        },
        "log.final.Mercury.COPP": {"value": 0.0001191262369582},
        "log.final.Mercury.OrbAngMom": {
            "value": 8.9600009443843100e38,
            "unit": (u.kg * u.m**2) / u.sec,
        },
        ...
        "log.final.Mercury.OrbPotEnergy": {
            "value": -1.6243570021016668e27,
            "unit": u.Joule,
        },
        "log.final.Mercury.PositionXSpiNBody": {"value": -1.4284864976318579e10},
        "log.final.Mercury.PositionYSpiNBody": {"value": 4.4617202242123146e10},
        "log.final.Mercury.PositionZSpiNBody": {"value": 4.9562860799520254e09},
        "log.final.Mercury.VelXSpiNBody": {"value": -5.6172594401899907e04},
        "log.final.Mercury.VelYSpiNBody": {"value": -1.3055052637623558e04},
        ...
        "log.final.Venus.MeanMotion": {
            "value": 3.2363398042052219e-07,
            "unit": 1 / u.sec,
        },
        "log.final.Venus.OrbPeriod": {"value": 1.9414479588995468e07, "unit": u.sec},
        "log.final.Venus.SemiMajorAxis": {"value": 1.0821018201844737e11, "unit": u.m},
        "log.final.Venus.COPP": {"value": 0.0000000000000000},
        "log.final.Venus.OrbAngMom": {
            "value": 1.8444477639687681e40,
            "unit": (u.kg * u.m**2) / u.sec,
        },
        ...
        "log.final.Venus.OrbPotEnergy": {
            "value": -3.4289361517490209e28,
            "unit": u.Joule,
        },
        "log.final.Venus.PositionXSpiNBody": {"value": 1.0815757144988359e11},
        "log.final.Venus.PositionYSpiNBody": {"value": 8.2767987284221296e09},
        "log.final.Venus.PositionZSpiNBody": {"value": -6.1349323261703272e09},
        "log.final.Venus.VelXSpiNBody": {"value": -2813.6433688321417321},
        "log.final.Venus.VelYSpiNBody": {"value": 3.4759390241093402e04},
        ...
        "log.final.Earth.MeanMotion": {
            "value": 1.9909898045534224e-07,
            "unit": 1 / u.sec,
        },
        "log.final.Earth.OrbPeriod": {"value": 3.1558098855201822e07, "unit": u.sec},
        "log.final.Earth.SemiMajorAxis": {"value": 1.4959770364503329e11, "unit": u.m},
        "log.final.Earth.COPP": {"value": 0.0064749041550423},
        "log.final.Earth.OrbAngMom": {
            "value": 2.6606451888126178e40,
            "unit": (u.kg * u.m**2) / u.sec,
        },
        ...
        "log.final.Earth.OrbPotEnergy": {
            "value": -1.5075691558931523e27,
            "unit": u.Joule,
        },
        "log.final.Earth.PositionXSpiNBody": {"value": 1.4648471525389093e11},
        "log.final.Earth.PositionYSpiNBody": {"value": -3.5305272424263519e10},
        "log.final.Earth.PositionZSpiNBody": {"value": -3.5065836082528394e08},
        "log.final.Earth.VelXSpiNBody": {"value": 6486.6780380224217879},
        "log.final.Earth.VelYSpiNBody": {"value": 2.8796295693817417e04},
        ...
        "log.final.Mars.MeanMotion": {
            "value": 1.0585624532113172e-07,
            "unit": 1 / u.sec,
        },
        "log.final.Mars.OrbPeriod": {"value": 5.9355830051581249e07, "unit": u.sec},
        "log.final.Mars.SemiMajorAxis": {"value": 2.2794298912143616e11, "unit": u.m},
        "log.final.Mars.COPP": {"value": -0.0161366204391489},
        "log.final.Mars.OrbAngMom": {
            "value": 3.4992868389766110e39,
            "unit": (u.kg * u.m**2) / u.sec,
        },
        ...
        "log.final.Mars.PositionXSpiNBody": {"value": 8.5927370326399353e10},
        "log.final.Mars.PositionYSpiNBody": {"value": -1.9293056341057376e11},
        "log.final.Mars.PositionZSpiNBody": {"value": -6.1583914211730099e09},
        "log.final.Mars.VelXSpiNBody": {"value": 2.3051619090597345e04},
        "log.final.Mars.VelYSpiNBody": {"value": 1.1937602122605942e04},
