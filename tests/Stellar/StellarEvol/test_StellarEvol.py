<<<<<<< HEAD:tests/StellarEvol/test_StellarEvol.py
...
@benchmark( 
   { 
       ...
       "log.final.system.DeltaTime": {"value": 2.658893e+10, "unit": u.sec, "rtol": 1e-4}, 
...
class Test_StellarEvol(Benchmark):
    pass
>>>>>>> 4c18ee466e6db05e4c7989dcb7a270145d630d3a:tests/Stellar/StellarEvol/test_StellarEvol.py
