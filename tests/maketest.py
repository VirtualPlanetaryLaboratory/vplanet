            ...
            for body in BodyName:
                ...
                if outputorder in data:
                    ...
                    data = ProcessOutputfile(
                        outputfile, data, body, OutputOrder)
...
def ProcessUnits(data):
    ...
    for k,v in data.items():
        ...
        if units == 'Rearth' or units == 'Earthradii' or units == 'earth radii' or units == 'Earth Radii':
            v[0] = 'u.Rearth'
        ...
        if (units == 'F/F_Earth'  or units == 'Initial Primordial Earth Number' or
            units == 'EMAGMOM' or 
            units == 'EMAGPAUSERAD'):
            v[0] = u.Unit(units)   
...
def Arguments():
    ...
    parser.add_argument(
        "dir", help="name of directory you want to run")
