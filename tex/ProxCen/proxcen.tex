...
shown in Figure \ref{fig:tidal_hec}.  We set  $k_{2_{ocean}} = 0.01$ and $k_{2_{enevelope}} = 0.01$ to
let the thermal interior set $k_2$ as the rocky portion of the planet dominates both the size and mass
of the planet.
...
oceans decreases the tidal Q leading to faster orbital
