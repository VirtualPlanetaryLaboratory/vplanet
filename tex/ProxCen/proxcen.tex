...
capable of mimicking biosignatures \citep{Schweiterman16,Meadows16}.
...
percent, for high enough quality data \citep{Kjeldsen95}. Indeed, these two stars
...
instellation, which places b in the ``conservative'' HZ of \cite{Kopparapu13}. Even allowing for observational
...
the evolution and potential habitability of Proxima depends on many other factors involving
...
\citep{AksnesFranklin01,Jackson08_evol}. In $\S$~\ref{sec:results} we
...
(low $Q$) \citep[\eg][]{Storch13}, so we will consider both
cases. \cite{ZhangHamilton06} found Neptune's $Q$ is about $10^4$ and
...
\citep[\eg][]{Korenaga06,Arevalo06,Huang13}. Note that geoneutrino
experiments are able to measure the decay products of $^{232}$Th and
$^{238}$U \citep{Araki05,Dye13}.
...
\citep{Gervasse98,Arevalo06}. Such high potassium abundances could be
...
\citep{DriscollOlson11,DriscollBercovici13,DriscollBarnes15}, and the
...
Proxima Centauri. The blue region is the HZ, which slowly moves
inwards for 500 Myr, reaching the current orbit of Proxima b after
about 200 Myr.
...
\end{center}
\caption{Evolution of the conservative HZ of Proxima Centauri, along
  with the orbits of Proxima Centauri b (solid line) and Mercury
  (dashed line).}
\label{fig:HZEvol}
\end{figure}
...
As described in $\S$~\ref{sec:methods:radheat} we consider four
...
power, mantle temperature, inner core radius, magnetic momet,
...
W/m$^2$~\citep{Strom79}. The humps and kinks are due to the changing
...
\xxx{\citep{DiscollBarnes15}}. Another possibility is that a recent
