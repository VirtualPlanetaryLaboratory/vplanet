...
or when it became gravitationally unbound ($e \gtr 1$). In set \textbf{A}, 1506 
...
\begin{figure}
\includegraphics[width=3.5in]{nomigration_minq.eps}
\includegraphics[width=3.5in]{migration_minq.eps}
\caption{}
\label{fig:finalminq}
\end{figure}
