...
percent, for high enough quality data \xxx{\citep{Chaplin2014}}. Indeed, these two stars
...
possess a significant water reservoir \citep{Mulders15}. For case 2,
...
instellation, which places b in the ``conservative'' HZ \cite{Kopparapu13}.
Even allowing for observational
...
\xxx{rd: I fixed the spelling of Driscoll}. Another possibility is that a recent
