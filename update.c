  ...
  *fnUpdate=malloc(control->Evolve.iNumBodies*sizeof(fnUpdateVariable**));
  ...
  for (iBody=0;iBody<control->Evolve.iNumBodies;iBody++) {
    ...
    if (update[iBody].iNumEnvelopeMass) {
      ...
      iEqn=0;
      for (iModule=0;iModule<module->iNumModules[iBody];iModule++) 
        module->fnFinalizeUpdateEnvelopeMass[iBody][iModule](body,update,&iEqn,iVar,iBody);
    ...
    */
    ...
    if (update[iBody].iNumMass) {
      ...
      iEqn=0;
      for (iModule=0;iModule<module->iNumModules[iBody];iModule++) 
        module->fnFinalizeUpdateMass[iBody][iModule](body,update,&iEqn,iVar,iBody);
    ...
    if (update[iBody].iNumIceMass) {
      ...
      iEqn=0;
      for (iModule=0;iModule<module->iNumModules[iBody];iModule++) 
        module->fnFinalizeUpdateIceMass[iBody][iModule](body,update,&iEqn,iVar,iBody);
