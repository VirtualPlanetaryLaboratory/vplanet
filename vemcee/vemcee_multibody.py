#	To do:	Move non-userspace files to resources folder
#		update readme file
...
import numpy as np, emcee, os, sys, configobj, time
...
def lnfit(x):
	...
	for axis in range(0,ndim):
		...
		#Return -infinity for areas outside the specified input parameter bounds
...
try:
	...
	print "Program called incorrectly. You need to include your input file when calling."
	graceful_exit(2)
