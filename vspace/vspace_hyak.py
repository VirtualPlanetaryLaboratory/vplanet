...
def parseInput(infile="input",src="."):
    ...
    Not really useful right now, but will be later I hope    
    ...
    return destfolder, trialname
# end function
    
def makeCommandList(simdir=".",destdir=".", outfile="hyakVpl.txt"):
    """
    ...
    with open(destdir + "/" + outfile,"w") as f:
        for line in dirs:
            line = "vplanet" + " " + line + "/vpl.in\n" # The run vplanet command
            f.write(line)
    
    return None
# end function
  
def makeHyakVPlanetPBS(script="run_vplanet.pbs",jobName="vpl_suite",nodes=1,
    ...
    with open(simdir + "/" + script,"w") as f:
        ...
        f.write("##\n")
        word = "cat " + script + " | parallel -j $HYAK_SLOTS --joblog"
...
#src = "/Users/dflemin3/Desktop/vplanet/vspace/example/test"
    
#makeCommandList(simdir=src,destdir=src)
